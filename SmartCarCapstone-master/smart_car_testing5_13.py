...
class HomeScreen(PageLayout):
    ...
    def __init__(self, **kwargs):
        ...
        #fetched OBD data every 10 second
        #Clock.schedule_interval(rpm, 100)
        #Clock.schedule_interval(mph, 100)
        #Clock.schedule_interval(fuel_level, 100)
        #Clock.schedule_interval(engine_coolant_temp, 100)
        #Clock.schedule_interval(engine_load, 100)
        #Clock.schedule_interval(run_time,100)
    ...
    def set_time(self,dt):
        ...
        #engine_coolant_temp=obd_data.engine_coolant_temp
        #engine_load=obd_data.engine_load
        #run_time=obd_data.run_time
